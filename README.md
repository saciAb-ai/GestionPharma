...
- La gestion des utilisateurs et des permissions (Admin, Pharmacien).
...
1.  **SoftDeletes** : Les ventes et produits supprimés ne sont pas effacés, mais archivés (colonne `deleted_at`), permettant leur restauration.
2.  **Strong Typing** : Usage des types dans les migrations (`decimal` pour les prix pour éviter les erreurs d'arrondi).
3.  **Factories** : Utilisation de données réalistes pour le développement local.
