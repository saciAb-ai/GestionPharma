...
<div class="text-center mt-3">
    <a href="javascript:void(0);" onclick="alert('Please contacts the System Administrator to reset your password.');" class="text-muted hover-primary">Forgot Password?</a>
</div>
