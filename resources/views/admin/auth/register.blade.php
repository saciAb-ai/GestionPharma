...
<form action="{{route('register')}}" method="POST">
	...
	<div class="form-group">
		<input class="form-control" name="email" type="email" value="{{old('email')}}" placeholder="example@example.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Veuillez inclure '@' et un point '.' après (ex: example@example.com)" required>
	</div>
	<div class="form-group">
